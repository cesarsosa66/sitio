...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2020 a las 04:45:09
...
INSERT INTO `datosgenerales` (`iddatos`, `imagen`, `telefono`, `correo`, `direccion`, `condicion`) VALUES
(1, '1591069811.jpg', '2664233232', 'aberturasquines@gmail.com', 'Calle Moreno S/N', 1);
...
INSERT INTO `localidades` (`id`, `id_select`, `localidad`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
(121, 1, 'Salliquelo'),
(122, 1, 'Salto'),
(123, 1, 'San Andres de Giles'),
(124, 1, 'San Antonio de Areco'),
(125, 1, 'San Antonio de Padua'),
(126, 1, 'San Bernardo'),
(127, 1, 'San Cayetano'),
(128, 1, 'San Clemente del Tuyu'),
(129, 1, 'San Nicolas'),
(130, 1, 'San Pedro'),
(131, 1, 'San Vicente'),
...
(147, 2, 'Adrogue'),
(148, 2, 'Aldo Bonzi'),
(149, 2, 'Area Reserva Cinturon Ecologico'),
(150, 2, 'Avellaneda'),
(151, 2, 'Banfield'),
(152, 2, 'Barrio Parque'),
...
(182, 2, 'Florida'),
(183, 2, 'Francisco Alvarez'),
(184, 2, 'Gerli'),
(185, 2, 'Glew'),
(186, 2, 'Gonzalez Catan'),
(187, 2, 'Gral. Lamadrid'),
(188, 2, 'Grand Bourg'),
...
(249, 2, 'Tigre'),
(250, 2, 'Tortuguitas'),
(251, 2, 'Tristan Suarez'),
(252, 2, 'Trujui'),
(253, 2, 'Turdera'),
(254, 2, 'Valentin Alsina'),
(255, 2, 'Vicente Lopez'),
(256, 2, 'Villa Adelina'),
...
(264, 2, 'Villa Dominico'),
(265, 2, 'Villa Espa?a'),
(266, 2, 'Villa Fiorito'),
(267, 2, 'Villa Guillermina'),
(268, 2, 'Villa Insuperable'),
(269, 2, 'Villa Jose Leon Suarez'),
...
(412, 5, 'Machagai'),
(413, 5, 'Makalle'),
(414, 5, 'Margarita Belen'),
(415, 5, 'Miraflores'),
(416, 5, 'Mision N. Pompeya'),
(417, 5, 'Napenay'),
(418, 5, 'Pampa Almiron'),
...
(614, 7, 'Embalse'),
(615, 7, 'Esquina'),
(616, 7, 'Estacion Gral. Paz'),
(617, 7, 'Estacion Juarez Celman'),
...
(815, 7, 'San Jeronimo'),
(816, 7, 'San Joaquin'),
(817, 7, 'San Jose de La Dormida'),
(818, 7, 'San Jose de Las Salinas'),
(819, 7, 'San Lorenzo'),
...
(998, 9, 'Aldea Sta. Maria'),
(999, 9, 'Aldea Sta. Rosa'),
(1000, 9, 'Aldea Valle Maria'),
(1001, 9, 'Altamirano Sur'),
(1002, 9, 'Antelo'),
(1003, 9, 'Antonio Tomas'),
(1004, 9, 'Aranguren'),
(1005, 9, 'Arroyo Baru'),
...
(1062, 9, 'Distrito Diego Lopez'),
(1063, 9, 'Distrito Pajonal'),
(1064, 9, 'Distrito Sauce'),
(1065, 9, 'Distrito Tala'),
(1066, 9, 'Distrito Talitas'),
(1067, 9, 'Don Cristobal 1? Seccion'),
(1068, 9, 'Don Cristobal 2? Seccion'),
(1069, 9, 'Durazno'),
(1070, 9, 'El Cimarron'),
(1071, 9, 'El Gramillal'),
(1072, 9, 'El Palenque'),
...
(1078, 9, '9'),
(1079, 9, 'Espinillo N.'),
(1080, 9, 'Estacion Campos'),
(1081, 9, 'Estacion Escri?a'),
(1082, 9, 'Estacion Lazo'),
(1083, 9, 'Estacion Raices'),
(1084, 9, 'Estacion Yerua'),
(1085, 9, 'Estancia Grande'),
(1086, 9, 'Estancia Libaros'),
(1087, 9, 'Estancia Racedo'),
(1088, 9, 'Estancia Sola'),
(1089, 9, 'Estancia Yuqueri'),
(1090, 9, 'Estaquitas'),
...
(1139, 9, 'Las Toscas'),
(1140, 9, 'Laurencena'),
(1141, 9, 'Libertador San Martin'),
(1142, 9, 'Loma Limpia'),
(1143, 9, 'Los Ceibos'),
(1144, 9, 'Los Charruas'),
(1145, 9, 'Los Conquistadores'),
(1146, 9, 'Lucas Gonzalez'),
(1147, 9, 'Lucas N.'),
(1148, 9, 'Lucas S. 1?'),
(1149, 9, 'Lucas S. 2?'),
(1150, 9, 'Macia'),
(1151, 9, 'Maria Grande'),
(1152, 9, 'Maria Grande 2?'),
(1153, 9, 'Medanos'),
(1154, 9, 'Mojones N.'),
(1155, 9, 'Mojones S.'),
(1156, 9, 'Molino Doll'),
...
(1191, 9, 'Raices Oeste'),
(1192, 9, 'Rincon de Nogoya'),
(1193, 9, 'Rincon del Cinto'),
(1194, 9, 'Rincon del Doll'),
(1195, 9, 'Rincon del Gato'),
(1196, 9, 'Rocamora'),
...
(1267, 10, 'Mision San Fco.'),
(1268, 10, 'Palo Santo'),
(1269, 10, 'Pirane'),
(1270, 10, 'Pozo del Maza'),
(1271, 10, 'Riacho He-He'),
(1272, 10, 'San Hilario'),
(1273, 10, 'San Martin II'),
(1274, 10, 'Siete Palmas'),
(1275, 10, 'Subteniente Perin'),
...
(1315, 11, 'Pampichuela'),
(1316, 11, 'Perico'),
(1317, 11, 'Puesto del Marques'),
(1318, 11, 'Puesto Viejo'),
(1319, 11, 'Pumahuasi'),
(1320, 11, 'Purmamarca'),
(1321, 11, 'Rinconada'),
(1322, 11, 'Rodeitos'),
(1323, 11, 'Rosario de Rio Grande'),
(1324, 11, 'San Antonio'),
...
(1484, 15, 'Col. Wanda'),
(1485, 15, 'Concepcion De La Sierra'),
(1486, 15, 'Corpus'),
(1487, 15, 'Dos Arroyos'),
(1488, 15, 'Dos de Mayo'),
(1489, 15, 'El Alcazar'),
...
(1575, 16, 'Plottier'),
(1576, 16, 'Quili Malal'),
(1577, 16, 'Ramon Castro'),
(1578, 16, 'Rincon de Los Sauces'),
(1579, 16, 'San Martin de Los Andes'),
...
(1586, 16, 'Varvarco'),
(1587, 16, 'Villa Curi Leuvu'),
(1588, 16, 'Villa del Nahueve'),
(1589, 16, 'Villa del Puente Picun Leuvu'),
(1590, 16, 'Villa El Chocon'),
...
(1652, 17, 'Pomona'),
(1653, 17, 'Prahuaniyeu'),
(1654, 17, 'Rincon Treneta'),
(1655, 17, 'Rio Chico'),
(1656, 17, 'Rio Colorado'),
(1657, 17, 'Roca'),
(1658, 17, 'San Antonio Oeste'),
(1659, 17, 'San Javier'),
(1660, 17, 'Sierra Colorada'),
(1661, 17, 'Sierra Grande'),
(1662, 17, 'Sierra Paileman'),
(1663, 17, 'Valcheta'),
(1664, 17, 'Valle Azul'),
(1665, 17, 'Viedma'),
(1666, 17, 'Villa Llanquin'),
...
(1831, 21, 'Pto. Deseado'),
(1832, 21, 'Pto. San Julian'),
(1833, 21, 'Pto. 21'),
(1834, 21, 'Rio Cuarto'),
(1835, 21, 'Rio Gallegos'),
(1836, 21, 'Rio Turbio'),
(1837, 21, 'Tres Lagos'),
(1838, 21, 'Veintiocho De Noviembre'),
(1839, 22, 'Aaron Castellanos'),
(1840, 22, 'Acebal'),
(1841, 22, 'Aguara Grande'),
(1842, 22, 'Albarellos'),
(1843, 22, 'Alcorta'),
(1844, 22, 'Aldao'),
(1845, 22, 'Alejandra'),
...
(1880, 22, 'Ca?ada de Gomez'),
(1881, 22, 'Ca?ada del Ucle'),
(1882, 22, 'Ca?ada Rica'),
(1883, 22, 'Ca?ada Rosquin'),
(1884, 22, 'Candioti'),
(1885, 22, 'Capital'),
(1886, 22, 'Capitan Bermudez'),
(1887, 22, 'Capivara'),
(1888, 22, 'Carcara?a'),
...
(1961, 22, 'Firmat'),
(1962, 22, 'Florencia'),
(1963, 22, 'Fortin Olmos'),
(1964, 22, 'Franck'),
(1965, 22, 'Fray Luis Beltran'),
(1966, 22, 'Frontera'),
(1967, 22, 'Fuentes'),
(1968, 22, 'Funes'),
(1969, 22, 'Gaboto'),
...
(2071, 22, 'Palacios'),
(2072, 22, 'Pavon'),
(2073, 22, 'Pavon Arriba'),
(2074, 22, 'Pedro Gomez Cello'),
(2075, 22, 'Perez'),
(2076, 22, 'Peyrano'),
(2077, 22, 'Piamonte'),
(2078, 22, 'Pilar'),
...
(2118, 22, 'San Cristobal'),
(2119, 22, 'San Eduardo'),
(2120, 22, 'San Eugenio'),
(2121, 22, 'San Fabian'),
(2122, 22, 'San Fco. de Santa Fe'),
(2123, 22, 'San Genaro'),
(2124, 22, 'San Genaro N.'),
(2125, 22, 'San Gregorio'),
(2126, 22, 'San Guillermo'),
(2127, 22, 'San Javier'),
(2128, 22, 'San Jeronimo del Sauce'),
(2129, 22, 'San Jeronimo N.'),
(2130, 22, 'San Jeronimo S.'),
(2131, 22, 'San Jorge'),
(2132, 22, 'San Jose de La Esquina'),
(2133, 22, 'San Jose del Rincon'),
(2134, 22, 'San Justo'),
(2135, 22, 'San Lorenzo'),
(2136, 22, 'San Mariano'),
(2137, 22, 'San Martin de Las Escobas'),
(2138, 22, 'San Martin N.'),
(2139, 22, 'San Vicente'),
...
(2182, 22, 'Villa Ana'),
(2183, 22, 'Villa Ca?as'),
(2184, 22, 'Villa Constitucion'),
(2185, 22, 'Villa Eloisa'),
(2186, 22, 'Villa Gdor. Galvez'),
(2187, 22, 'Villa Guillermina'),
(2188, 22, 'Villa Minetti'),
(2189, 22, 'Villa Mugueta'),
(2190, 22, 'Villa Ocampo'),
(2191, 22, 'Villa San Jose'),
...
(2214, 23, 'El Charco'),
(2215, 23, 'El Mojon'),
(2216, 23, 'Estacion Atamisqui'),
(2217, 23, 'Estacion Simbolar'),
(2218, 23, 'Fernandez'),
(2219, 23, 'Fortin Inca'),
(2220, 23, 'Frias'),
(2221, 23, 'Garza'),
...
(2282, 25, 'Arcadia'),
(2283, 25, 'Atahona'),
(2284, 25, 'Banda del Rio Sali'),
(2285, 25, 'Bella Vista'),
(2286, 25, 'Buena Vista'),
(2287, 25, 'Burruyacu'),
(2288, 25, 'Capitan Caceres'),
...
(2368, 25, 'Sta. Lucia'),
(2369, 25, 'Taco Ralo'),
(2370, 25, 'Tafi del Valle'),
(2371, 25, 'Tafi Viejo'),
(2372, 25, 'Tapia'),
(2373, 25, 'Teniente Berdina'),
(2374, 25, 'Trancas'),
(2375, 25, 'Villa Belgrano'),
(2376, 25, 'Villa Benjamin Araoz'),
...
INSERT INTO `materiales` (`idmaterial`, `nombre_material`, `condicion`) VALUES
(1, 'Alumnio', 1),
(2, 'Hierro', 1),
(3, 'Madera', 1),
(4, 'Vidrio', 1);
...
(5, 'Materiales'),
(6, 'Productos'),
(7, 'Consulta de Alumnos'),
(8, 'Situacion del alumno'),
(9, 'Documentación del Alumno');
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  KEY `idcategoria` (`idcategoria`,`idmaterial`)
...
INSERT INTO `productos` (`idproducto`, `nombre`, `idcategoria`, `idmaterial`, `medidas`, `color`, `imagen`, `condicion`) VALUES
(1, 'Puerta Corrediza', 1, 3, '120x120', 'Marron Cafe', '1591583184.jpg', 1),
(2, 'Ventana xx1', 2, 1, '120x90', 'Blanco', '1591583274.jpg', 1);
...
CREATE TABLE IF NOT EXISTS `tbl_image` (
  ...
  KEY `fk_tbl_image_alumno1_idx` (`idalumno`),
  KEY `idgrado` (`idgrado`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- Volcado de datos para la tabla `tbl_image`
--

INSERT INTO `tbl_image` (`idimagen`, `idalumno`, `idgrado`, `imagen`, `fecha_pre`, `condicion`) VALUES
(1, 1, 1, '1584186323.jpg', '2020-03-14', 1),
(2, 1, 1, '1584186344.jpg', '2020-03-14', 1);
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `condicion` varchar(45) DEFAULT '1',
...
INSERT INTO `usuario` (`idusuario`, `nombre`, `tipo_documento`, `num_documento`, `direccion`, `telefono`, `email`, `cargo`, `login`, `clave`, `imagen`, `hash`, `condicion`) VALUES
(1, 'Cesar Gustavo Sosa', 'DNI', '39394123', 'banda este', '2664928424', 'cesargustavos2020@gmail.com', 'ADMINISTRADOR', 'admin', 'admin', '1591067540.jpg', '', '1'),
(2, 'Marcos Maidan', 'DNI', '23678654', 'Sarmiento 280', '0266154658905', 'marcosmaidan34@gmail.com', 'Secretario Administrativo', 'marcos', '1234', '1584183174.jpg', '', '1');
...
CREATE TABLE IF NOT EXISTS `usuario_permiso` (
  ...
  KEY `fk_permiso_has_usuario_usuario1_idx` (`idusuario`),
  KEY `fk_permiso_has_usuario_permiso1_idx` (`idpermiso`)
